...
export function ClientPortalDossierPage() {
  ...
  useEffect(() => {
    ...
    setTab(1);
    setUploadOpen(true);
  }, [expectations.data, searchParams]);

  const openGenericUpload = (nextCategory = "BOITE_RECEPTION") => {
    setSelectedExpectation(null);
    setCategory(nextCategory);
    setUploadOpen(true);
  };

  const openExpectationUpload = (expectation: MissingDocumentExpectation) => {
    setSelectedExpectation(expectation);
    setCategory(expectation.category);
    setUploadOpen(true);
  };
