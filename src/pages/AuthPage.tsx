    ...
    <main className="auth-page">
      <section className="auth-visual">
        ...
        <Box
          ...
          sx={{ position: "relative", zIndex: 1, maxWidth: 560 }}
        >
          <Typography
            variant="overline"
            sx={{ color: "#f2c56b", letterSpacing: ".16em" }}
          >
            {t("Conçu pour les cabinets tunisiens")}
          </Typography>
          <Typography
            variant="h1"
            sx={{
        ...
        <Box
          sx={{ position: "relative", zIndex: 1, display: "grid", gap: 1.4 }}
        >
          {[
            "Données isolées par cabinet",
            "Accès contrôlé selon chaque rôle",
            "Règles fiscales tunisiennes versionnées",
          ].map((item) => (
            <Box
              key={item}
              sx={{
      ...
      <section className="auth-form-wrap">
        ...
        >
          ...
          <Typography
            variant="h2"
            sx={{ mt: 1, mb: 1, fontSize: { xs: 38, sm: 48 } }}
          >
            {isRegister ? t("Créer votre espace") : t("Bon retour parmi nous")}
          </Typography>
          <Typography color="text.secondary" sx={{ mb: 4 }}>
            {isRegister
              ? t("Créez le premier compte propriétaire de votre cabinet.")
              : t("Connectez-vous pour reprendre le travail de votre cabinet.")}
          </Typography>
            ...
            {!isRegister && (
              <Box sx={{ display: "flex", justifyContent: "flex-end", mt: -1 }}>
                <RouterLink
                  ...
                  style={{ color: "#145a46", fontWeight: 700, fontSize: 14 }}
                >
          ...
          >
            ...
            <RouterLink
              ...
              style={{ color: "#145a46", fontWeight: 700 }}
            >
